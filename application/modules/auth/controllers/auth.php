...
class Auth extends CI_Controller {
	...
	public function index()
	{
		if($this->session->userdata('logged_in')=="")
		{
			...
			else
			{
				...
				$dt['stts'] = $this->input->post('stts');
				$this->auth_login->getLoginData($dt);
			}
		}
		...
		else if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="guru")
		{
			header('location:'.base_url().'teacher');
		}
		else if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="siswa")
		{
	...
	public function setting_account()
	{
		if($this->session->userdata('logged_in')!="" && $this->session->userdata('stts')=="administrator")
		{
			...
			$this->load->view('auth/setting_account');
		}
		else
		{
