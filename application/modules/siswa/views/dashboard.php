					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content">
								<div class="hero-unit">
							        <p>Sistem Informasi Akademik Pesantren Bahrul Ulum ini merupakan sebuah aplikasi untuk melakukan manajemen data siswa. Silahkan untuk melakukan manajemen atau pengolahan data kesiswaan sesuai dengan hak akses yang anda miliki.</p>
      							</div>
