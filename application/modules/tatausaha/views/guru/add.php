			<div id="breadcrumb">
				...
				<a href="#" class="current"> <?php echo $status; ?> Data Guru</a>
			</div>
			
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<?php echo form_open_multipart('tatausaha/guru/save','class="form-horizontal"'); ?>
						...
						<?php } ?>
							<div class="widget-box">
								...
								<h5><?php echo $status; ?> Data Guru</h5>
							</div>
							<div class="widget-content nopadding">
								<form action="#" method="get" class="form-horizontal" />
									...
									<div class="controls">
										<input type="text" class="span6" name="nip"  value="<?php echo $nip; ?>" placeholder="NIP">
									</div>
									<label class="control-label">Nama Guru</label>
									<div class="controls">
										<input type="text" class="span6" name="nama"  value="<?php echo $nama; ?>" placeholder="Nama Guru">
									</div>
