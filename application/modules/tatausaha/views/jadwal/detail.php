					...
					<div class="span12">
    					...
    					<?php } ?>
							<div class="widget-box">
								...
								<h5><?php echo $stts; ?> Pengajaran</h5>
							</div>
							<div class="widget-content nopadding">
								<form action="#" method="get" class="form-horizontal" />
									<label class="control-label" >Nama Guru</label>
										<div class="controls">
											<select data-placeholder="Nama Guru" class="chzn-select" style="width:500px;" tabindex="2" name="id_guru" id="id_guru" disabled>
          										<option value=""></option>
													<?php
														foreach($nip->result_array() as $f)
														{
															if($f['id_guru']==$id_guru)
																{
																	?>
																		<option value="<?php echo $f['nip']; ?>" selected="selected"><?php echo $f['nama']; ?></option>
																	<?php
																}
															else
																{
																	?>
																		<option value="<?php echo $f['nip']; ?>"><?php echo $f['nama']; ?></option>
																	<?php
																}
														}
													?>
									...
									<label class="control-label" >Mata Pelajaran</label>
										<div class="controls">
											<select data-placeholder="Mata Pelajaran" class="chzn-select" style="width:500px;" tabindex="2" name="id_mata_pelajaran" id="id_mata_pelajaran" disabled>
          										<option value=""></option>
													<?php
									...
									<label class="control-label" >Kelas</label>
										...
										<div class="controls">
											<select data-placeholder="Hari" class="chzn-select" style="width:500px;" tabindex="2" name="id_hari" id="id_hari" disabled>
          										<option value=""></option>
													<?php
										...
										<div class="controls">
											<select data-placeholder="Jam Pelajaran " class="chzn-select" style="width:500px;" tabindex="2" name="id_jam" id="id_jam" disabled>
          										<option value=""></option>
													<?php
									...
									<input type="hidden" name="stts" value="<?php echo $stts; ?>">
										<div class="control-group">
											<div class="controls">
			  									<a class="btn btn-primary" href="<?php echo base_url(); ?>tatausaha/jadwal/index/<?php  ?>">Kembali</a>
											</div>
		  								</div>
								</form>
							</div>
