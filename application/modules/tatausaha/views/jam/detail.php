    					...
    					<?php } ?>
							...
							<div class="widget-content nopadding">
								<form action="#" method="get" class="form-horizontal" />
									...
									<div class="controls">
										<input type="text" class="span6" name="jam"  value="<?php echo $jam; ?>" placeholder="Jam Pelajaran" disabled>
									</div>
									<input type="hidden" name="id_param" value="<?php echo $id_param; ?>">
									<input type="hidden" name="stts" value="<?php echo $stts; ?>">
										<div class="control-group">
											<div class="controls">
			  									<a class="btn btn-primary" href="<?php echo base_url(); ?>tatausaha/jam/index/<?php  ?>">Kembali</a>
											</div>
		  								</div>
								</form>
							</div>
