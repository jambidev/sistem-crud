			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
							...
							<div class="controls">
								<input type="hidden" class="span6" name="kelas" id="kelas" value="<?php echo $kelas; ?>" placeholder="NILAI">
							</div>
							<div class="controls">
								<input type="hidden" class="span6" name="id_mata_pelajaran" id="id_mata_pelajaran" value="<?php echo $id_mata_pelajaran; ?>" placeholder="NILAI">
							</div>
  					...
  					<table class="table ">
    					...
    					<tbody>
    						...
    						<tr>
        						...
        						<td >
									<div class="controls">
										<input type="text" class="span3" name="nilai" id="nilai" value="<?php echo $nilai; ?>" placeholder="NILAI" disabled>
									</div>
								</td>
								<td>
	        						<div class="btn-group">
