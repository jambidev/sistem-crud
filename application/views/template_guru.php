	...
	<body>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li><a href="<?php echo base_url(); ?>teacher/nilai"><i class="icon-book"></i> <span>Input Nilai</span></a></li>
				<li><a href="<?php echo base_url(); ?>teacher/lihat_nilai"><i class="icon-list-alt"></i> <span>Lihat Nilai</span></a></li>
				<li><a href="<?php echo base_url(); ?>teacher/jadwal"><i class="icon-file"></i> <span>Jadwal Pengajaran</span></a></li>
